...
public class UserDBDAO {
	...
	public User selectSingline2(String[] columns, String selection,
	...
	public List<User> selectAll2(String[] columns, String selection,
		...
		try {
			...
			if (cs != null) {
				...
				while (cs.moveToNext()) {
					...
					String name = cs.getString(cs.getColumnIndex("name"));
					String mima = cs.getString(cs.getColumnIndex("mima"));
					User user = new User(id, name, mima);
					list.add(user);
				}
			}
		} catch (Exception e) {
